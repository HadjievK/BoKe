...
export default function SignInPage() {
  ...
  // Check if Google OAuth is available (check on client side via API)
            ...
            <>
              ...
              >
                <motion.button
                  ...
                  className="w-full bg-white border-2 border-gray-200 text-gray-900 py-3 rounded-lg font-semibold hover:bg-gray-50 hover:border-indigo-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
